    ...
    <div className="flex items-center justify-between px-6 py-4">
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-[260px]">
          <input
            className="w-full h-10 pl-9 pr-3 border border-[#d5d7da] rounded-lg text-sm text-[#717680] bg-white shadow-sm focus:outline-none focus:ring-1 focus:ring-[#0063f5] dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:placeholder:text-slate-500"
            placeholder="Search by Order ID, Customer ID, Name..."
          />
          <Search className="absolute left-3 top-3 w-4 h-4 text-[#9aa4b2] dark:text-slate-500" />
        </div>
