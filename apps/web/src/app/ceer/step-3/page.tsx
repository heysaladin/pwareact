...
export default function VerifyingMobilePage() {
  ...
  const allRequired = checked[0] && checked[1] && checked[2];
        ...
        <div className="flex-1 px-10 py-8 overflow-y-auto">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <div className="flex flex-col items-end gap-1">
              <button onClick={() => allRequired && router.push('/ceer/step-4')} className={`font-bold px-8 py-3.5 rounded-xl text-sm transition-colors ${allRequired ? 'bg-[#E87722] border border-[#E87722] text-white cursor-pointer' : 'bg-[#1a1a1a] border border-white/10 text-white/30 cursor-not-allowed'}`}>
                Agree &amp; Continue →
              </button>
