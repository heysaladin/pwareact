                        ...
                        <div className="w-[380px] shrink-0 bg-black/40 border border-white/[0.07] rounded-2xl p-5 backdrop-blur-sm">
                          ...
                          <div className="flex flex-col gap-1.5 mb-3">
                            {[
                              ...
                              { label: 'Approve to request using your biometrics', icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"/></svg> },
