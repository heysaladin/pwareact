...
export default function PaymentPageAr() {
  ...
  return (
    <div className="bg-[#E8EBF0] min-h-screen flex items-center justify-center" dir="rtl">
      <div className="bg-white rounded-[16px] shadow-lg w-[512px] p-8 flex flex-col gap-6">

        {/* Apple Pay button */}
        <button onClick={() => router.push('/code/ar')} className="bg-black text-white rounded-[8px] py-4 w-full flex items-center justify-center gap-3 text-[18px] font-medium">
        ...
        {/* STC Pay button */}
        <button onClick={() => router.push('/code/ar')} className="bg-[#7B2D8B] text-white rounded-[8px] py-4 w-full flex items-center justify-center text-[18px] font-medium">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[#9AA4B2] text-[14px]">أو الدفع ببطاقة</span>
          <hr className="flex-1 border-[#E4E7EC]" />
        </div>

        {/* Name on card */}
        <div className="flex flex-col">
          <label className="text-[14px] font-medium text-[#101828] mb-2">الاسم على البطاقة</label>
          <input
            type="text"
        ...
        {/* Card information */}
        <div className="flex flex-col">
          <label className="text-[14px] font-medium text-[#101828] mb-2">معلومات البطاقة</label>
        ...
        {/* Pay button */}
        <button onClick={() => router.push('/code/ar')} className="bg-[#1A3C8F] text-white rounded-[8px] py-4 w-full text-[18px] font-semibold text-center">
          ادفع 200.00 ريال
        </button>

        {/* Powered by Moyasar */}
        <p className="text-center text-[14px] text-[#9AA4B2] mt-2">مدعوم من Moyasar</p>
